...
//		hotfix 34
//		hotfix 35
//		hotfix 35_1 *minor crash fix patch
//		hotfix 36
...
//	vulkan
state("bg3", "gog_hotfix_34")
{
	byte is_playable : 0x6295C98, 0xA9;
	string64 level_name : 0x6295C98, 0x183;
	string64 level_descriptive_name : 0x6295C98, 0x1C4;
	string32 game_version : 0x6295C98, 0x284;
	string256 log_message : 0x62964E0, 0x0, 0x28;
	float node_x : 0x6296498, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x6296498, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x6296498, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x6292EC0, 0x10, 0x20, 0x2D8, 0x688;
}

//	directx 11
state("bg3_dx11", "gog_hotfix_34")
{
	byte is_playable : 0x600E178, 0xA9;
	string64 level_name : 0x600E178, 0x183;
	string64 level_descriptive_name : 0x600E178, 0x1C4;
	string32 game_version : 0x600E178, 0x284;
	string256 log_message : 0x600E948, 0x0, 0x28;
	float node_x : 0x600E908, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x600E908, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x600E908, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x600B3C8, 0x10, 0x20, 0x2D8, 0x688;
}

//	vulkan
state("bg3", "steam_hotfix_34")
{
	byte is_playable : 0x62A2E18, 0xA9;
	string64 level_name : 0x62A2E18, 0x183;
	string64 level_descriptive_name : 0x62A2E18, 0x1C4;
	string32 game_version : 0x62A2E18, 0x284;
	string256 log_message : 0x62A3660, 0x0, 0x28;
	float node_x : 0x62A3618, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x62A3618, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x62A3618, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x62A0048, 0x10, 0x20, 0x2D8, 0x688;
}

//	directx 11
state("bg3_dx11", "steam_hotfix_34")
{
	byte is_playable : 0x6019118, 0xA9;
	string64 level_name : 0x6019118, 0x183;
	string64 level_descriptive_name : 0x6019118, 0x1C4;
	string32 game_version : 0x6019118, 0x284;
	string256 log_message : 0x6019910, 0x0, 0x28;
	float node_x : 0x60198C8, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x60198C8, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x60198C8, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x6016378, 0x10, 0x20, 0x2D8, 0x688;
}

//	vulkan
state("bg3", "gog_hotfix_35")
{
	byte is_playable : 0x6297D18, 0xA9;
	string64 level_name : 0x6297D18, 0x183;
	string64 level_descriptive_name : 0x6297D18, 0x1C4;
	string32 game_version : 0x6297D18, 0x284;
	string256 log_message : 0x6298560, 0x0, 0x28;
	float node_x : 0x6298518, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x6298518, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x6298518, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x6294F30, 0x10, 0x20, 0x2D8, 0x688;
}

//	directx 11
state("bg3_dx11", "gog_hotfix_35")
{
	byte is_playable : 0x600E368, 0xA9;
	string64 level_name : 0x600E368, 0x183;
	string64 level_descriptive_name : 0x600E368, 0x1C4;
	string32 game_version : 0x600E368, 0x284;
	string256 log_message : 0x600EB38, 0x0, 0x28;
	float node_x : 0x600EAF8, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x600EAF8, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x600EAF8, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x600B5C8, 0x10, 0x20, 0x2D8, 0x688;
}
...
//	vulkan
state("bg3", "gog_hotfix_35_1")
{
	byte is_playable : 0x62A6C68, 0xA9;
	string64 level_name : 0x62A6C68, 0x183;
	string64 level_descriptive_name : 0x62A6C68, 0x1C4;
	string32 game_version : 0x62A6C68, 0x284;
	string256 log_message : 0x62A74B0, 0x0, 0x28;
	float node_x : 0x62A7468, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x62A7468, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x62A7468, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x62A3EA8, 0x10, 0x20, 0x2D8, 0x688;
}

//	directx 11
state("bg3_dx11", "gog_hotfix_35_1")
{
	byte is_playable : 0x601C348, 0xA9;
	string64 level_name : 0x601C348, 0x183;
	string64 level_descriptive_name : 0x601C348, 0x1C4;
	string32 game_version : 0x601C348, 0x284;
	string256 log_message : 0x601CB28, 0x0, 0x28;
	float node_x : 0x601CAE8, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x601CAE8, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x601CAE8, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x60195C0, 0x10, 0x20, 0x2D8, 0x688;
}

//	vulkan
state("bg3", "steam_hotfix_35_1")
{
	byte is_playable : 0x62B1CE8, 0xA9;
	string64 level_name : 0x62B1CE8, 0x183;
	string64 level_descriptive_name : 0x62B1CE8, 0x1C4;
	string32 game_version : 0x62B1CE8, 0x284;
	string256 log_message : 0x62B2530, 0x0, 0x28;
	float node_x : 0x62B24E8, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x62B24E8, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x62B24E8, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x62AEF00, 0x10, 0x20, 0x2D8, 0x688;
}

//	directx 11
state("bg3_dx11", "steam_hotfix_35_1")
{
	byte is_playable : 0x6028568, 0xA9;
	string64 level_name : 0x6028568, 0x183;
	string64 level_descriptive_name : 0x6028568, 0x1C4;
	string32 game_version : 0x6028568, 0x284;
	string256 log_message : 0x6028D58, 0x0, 0x28;
	float node_x : 0x6028D18, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x6028D18, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x6028D18, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x60257D0, 0x10, 0x20, 0x2D8, 0x688;
}

//	vulkan
state("bg3", "gog_hotfix_36")
{
	byte is_playable : 0x62A6D78, 0xA9;
	string64 level_name : 0x62A6D78, 0x183;
	string64 level_descriptive_name : 0x62A6D78, 0x1C4;
	string32 game_version : 0x62A6D78, 0x284;
	string256 log_message : 0x62A75C0, 0x0, 0x28;
	float node_x : 0x62A7578, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x62A7578, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x62A7578, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x62A3FB0, 0x10, 0x20, 0x2D8, 0x688;
}

//	directx 11
state("bg3_dx11", "gog_hotfix_36")
{
	byte is_playable : 0x601D208, 0xA9;
	string64 level_name : 0x601D208, 0x183;
	string64 level_descriptive_name : 0x601D208, 0x1C4;
	string32 game_version : 0x601D208, 0x284;
	string256 log_message : 0x601D9D8, 0x0, 0x28;
	float node_x : 0x601D998, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x601D998, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x601D998, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x601A478, 0x10, 0x20, 0x2D8, 0x688;
}

//	vulkan
state("bg3", "steam_hotfix_36")
{
	byte is_playable : 0x62B2DA8, 0xA9;
	string64 level_name : 0x62B2DA8, 0x183;
	string64 level_descriptive_name : 0x62B2DA8, 0x1C4;
	string32 game_version : 0x62B2DA8, 0x284;
	string256 log_message : 0x62B35F0, 0x0, 0x28;
	float node_x : 0x62B35A8, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x62B35A8, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x62B35A8, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x62AFFC8, 0x10, 0x20, 0x2D8, 0x688;
}

//	directx 11
state("bg3_dx11", "steam_hotfix_36")
{
	byte is_playable : 0x6029448, 0xA9;
	string64 level_name : 0x6029448, 0x183;
	string64 level_descriptive_name : 0x6029448, 0x1C4;
	string32 game_version : 0x6029448, 0x284;
	string256 log_message : 0x6029C38, 0x0, 0x28;
	float node_x : 0x6029BF8, 0x2F0, 0x38, 0x38, 0x10;
	float node_y : 0x6029BF8, 0x2F0, 0x38, 0x38, 0x14;
	float node_z : 0x6029BF8, 0x2F0, 0x38, 0x38, 0x18;

	string32 ui_state : 0x60266C0, 0x10, 0x20, 0x2D8, 0x688;
}
...
//		{ "4.1.1.4061076", "gog_patch_5" },
		...
		{ "4.1.1.6946847", "gog_hotfix_34" },
		{ "4.1.1.6995620", "gog_hotfix_35" },
		{ "4.1.1.7151330", "gog_hotfix_35_1" },
		{ "4.1.1.7209685", "gog_hotfix_36" },
	};
	...
	Dictionary<String, String> steam_version_map = new Dictionary<String, String>()
	{
		...
		{ "4.1.1.7151330", "steam_hotfix_35_1" },
		{ "4.1.1.7209685", "steam_hotfix_36" },
	};
